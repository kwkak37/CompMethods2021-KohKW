...
\renewcommand{\forcedate}{\today}\date{\forcedate}
...
\begin{tikzpicture}[auto, thick]
    \node (GeneralInterests) at (-4,3) [rectangle,draw=blue!50,fill=red!20,text width=2.5cm,text badly centered,label={[align=center]above:Voters}] {Public Scrutiny};
    \node (SpecialInterests) at (4,3)[rectangle,draw=blue!50,fill=green!20,text width=4cm,text badly centered,label={[align=center]above:Financial Industry}] {Lobbying Expenditures, Campaign Contributions};
