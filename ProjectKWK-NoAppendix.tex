...
\keywords{Financial Deregulation, Close Elections}
...
\begin{abstract}
This paper builds upon Igan and Mishra (2014) \cite{IM14} on vote switches towards financial deregulation by US legislators. I measure the effect of close elections on US legislators on switching their votes towards financial deregulation in Congress bills. I aim to distinguish between votd switches towards financial deregulation because of voters' general interests (especially after the Global Financial Crisis of 2007) versus the financial industry's special interests and the industry's campaign contributions and lobbying expenditures towards legislators in close elections.
\end{abstract}
...
\begin{tikzpicture}[auto, thick]
    \node (GeneralInterests) at (-3,3) [rectangle,draw=blue!50,fill=red!20,text width=2.5cm,text badly centered,label={[align=center]above:Voters}] {Public Scrutiny};
    \node (SpecialInterests) at (3,3)[rectangle,draw=blue!50,fill=green!20,text width=4cm,text badly centered,label={[align=center]above:Financial Industry}] {Lobbying Expenditures, Campaign Contributions};
    \node (ElectionCloseness) at (0,0) [rectangle,draw=blue!50,fill=blue!20,text width = 3.5cm, text badly centered]{Election Closeness (Margin of Victory)};
    \node (VoteSwitch) at (0,-3) [rectangle,draw=blue!50,fill=black!20,text width = 3cm, text badly centered,label={[align=center]below:Legislators}] {Vote Switch towards Financial Deregulation};
    ...
    \draw [->] (SpecialInterests.south) --node{\textcolor{blue}{+ (More likely to switch vote)}} (ElectionCloseness.north);
\end{tikzpicture}
...
Sample Text for ProjectKWK: Lorem Ipsum et cetera. Try citing Igan and Mishra (2014) ~\cite{IM14}.
